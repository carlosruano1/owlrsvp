        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="glass-card rounded-2xl p-8">
            ...
            <div className="bg-black/30 p-6 rounded-xl mb-8">
              ...
              <ul className="space-y-3 text-left">
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-blue-500/30 rounded-full flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/create"
                className="px-8 py-3 border border-white/30 text-white font-semibold rounded-xl hover:bg-white/10 hover:border-white/50 transition-all"
              >
                Create New Event
              </Link>
            </div>
