...
export function generateTeamInvitationEmail(inviterEmail: string, teamName: string, inviteUrl: string, message?: string) {
  ...
  const html = `
    ...
    <body>
      ...
      <div class="content">
        ...
        <p><strong>${inviterEmail}</strong> has invited you to join their OwlRSVP team.</p>

        ${message ? `<div class="message">"${message}"</div>` : ''}

        <div class="features">
          <h3>As a team member, you'll be able to:</h3>
          <ul>
            <li>Manage events assigned to you by the team owner</li>
            <li>View and edit RSVP responses</li>
            <li>Export attendee data to CSV</li>
            <li>Access event analytics and insights</li>
            <li>Send communications to event guests</li>
          </ul>
        </div>

        <p><strong>Note:</strong> This is a team management feature available only for Pro and Enterprise subscribers.</p>
        ...
        <p><strong>Don't have an OwlRSVP account yet?</strong> The invitation link will guide you through creating one using the email address you were invited with.</p>
      </div>
      <div class="footer">
        <p>Best regards,<br>The OwlRSVP Team</p>
        <p>This email was sent from noreply@owlrsvp.com</p>
  ...
  const text = `
    You're invited to join the ${teamName} team - OwlRSVP

    You're Invited to Join the Team!

    ${inviterEmail} has invited you to join their OwlRSVP team.

    ${message ? `Message from ${inviterEmail}: "${message}"` : ''}

    As a team member, you'll be able to:
    - Manage events assigned to you by the team owner
    - View and edit RSVP responses
    - Export attendee data to CSV
    - Access event analytics and insights
    - Send communications to event guests

    Note: This is a team management feature available only for Pro and Enterprise subscribers.
    ...
    Don't have an OwlRSVP account yet? The invitation link will guide you through creating one using the email address you were invited with.
